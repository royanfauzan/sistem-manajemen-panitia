        ...
        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-start align-items-sm-start"
            ...
            <li>
                ...
                <ul class="collapse nav flex-column ms-1" id="submenu1" data-bs-parent="#menu">
                    ...
                    <li>
                        <a href="/mylistkegiatan" class="nav-link text-secondary px-0"> <span class="d-none d-sm-inline">Diikuti</span> <i class="bi bi-bookmark-plus"></i>
                        </a>
                    </li>
                </ul>
            </li>
            ...
            <li>
                <a href="/rekrut" class="nav-link text-white px-0 align-middle">
